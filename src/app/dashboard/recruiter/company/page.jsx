...
export default function CompanyProfile({ recruiterCompany }) {
    // 1. Core State
    ...
    // 3. Submit Profile Form Data (Pure Client-Side State Handling)
            ...
            <div className="max-w-4xl mx-auto my-8 bg-zinc-950 border border-zinc-900 rounded-xl p-8 space-y-8">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b border-zinc-900 pb-6">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <a href={`https://${company.websiteUrl}`} target="_blank" rel="noreferrer" className="text-sm text-zinc-400 hover:underline flex items-center gap-1 mt-1">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="bg-zinc-900/30 border border-zinc-900 p-4 rounded-lg">
                        ...
                        <span className="text-zinc-300 font-medium mt-1 block capitalize">{company.employeeCount} employees</span>
                    </div>
                </div>
            ...
            <Form onSubmit={handleSubmit} className="space-y-8" validationErrors={errors} validationBehavior="aria">
                <Fieldset className="space-y-6 w-full">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
                        ...
                        {/* Custom Styled Upload Block matching blueprint */}
