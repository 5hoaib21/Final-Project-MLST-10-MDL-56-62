                ...
                <div className="flex items-center justify-between mb-1">
                  ...
                  >
                    {({ isSelected }) => (
                      <>
                        <Switch.Control
                          className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors duration-200 ${isSelected ? "bg-white" : "bg-zinc-800"}`}
                        >
                          <Switch.Thumb
                            className={`inline-block h-4 w-4 transform rounded-full transition-transform duration-200 ${isSelected ? "translate-x-6 bg-black" : "translate-x-1 bg-zinc-400"}`}
                          />
                        </Switch.Control>
                        <Switch.Content>
                          <Label className="text-xs text-zinc-400 font-medium ml-2">
                            Remote
                          </Label>
                        </Switch.Content>
                      </>
